...
from modules.chat_frame import ChatFrame
from modules.product_explorer import ProductExplorer
...
from modules.theme import apply_theme, apply_font_size
...
class MainWindow(QMainWindow):
    ...
    def load_config(self):
        ...
        config = {
            ...
            "integrated_data_dir": str(Path("./integrated_data")),
            "technical_data_dir": str(Path("./extracted_data/technical")),
            "compatibility_data_dir": str(Path("./extracted_data/compatibility")),
            "article_data_dir": str(Path("./extracted_data/artikel")),
    ...
    def on_product_selected(self, product_id, file_path):
        ...
        self.chat_frame.set_active_product(product_id)
