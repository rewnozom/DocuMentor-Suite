...
#### Trådlös plug-in-dörrklocka med viloläge, nattbelysning och tryckknapp - Vit

Den snygga och kompakta modellen Honeywell DC515NP2 med oöverträffat ljud är en plug-in-dörrklocka som aldrig behöver batterier och som är designad för din livsstil. Den har även viloläge så att du kan koppla av utan att bli störd och den innovativa nattbelysningen med 7 valbara färger vägleder dig i mörkret med sitt mjuka och behagliga sken.
...
| Förpackning                         |                                      |
|-------------------------------------|--------------------------------------|
| EAN-kod                             | 5004100965554                        |
| Förpackningens mått (mm) / Vikt (g) | 216 (h) x 150 (b) x 88 (d) / 420 (g) |
