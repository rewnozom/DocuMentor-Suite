...
**D001012089 6 2021-03-10 Assembly instruction 1 (12)**

# **Monteringsanvisning nödutrymningsbeslag 179I**

|                                               | 2391 |      | ASSA ABLOY Opening Solutions Sweden AB<br>Kungsgatan 71<br>SE-632 21 Eskilstuna<br>Sweden |                                                                                             |         |   |    |    |
|-----------------------------------------------|------|------|-------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|---------|---|----|----|
...
| 4   | Lämplighet för<br>användning på<br>brand/röktäta dörrar | B**  | Lämplig att användas på<br>brand/röktäta dörrar<br>brandtestade enligt EN<br>1634-1. **Gäller i<br>kombination med annan<br>produkt som håller<br>dörren stängd i händelse<br>av brand |
...
| 4   | Suitability for use on<br>fire/smoke doors | B**   | Suitable for use on fire<br>and smoke door<br>assemblies based on a<br>test in accordance with<br>EN 1634-1. **In<br>addition with other<br>product that keeps the<br>door closed in case of<br>fire |
...
| D001012089  | 6        | 2021-03-10 | Assembly instruction | 8 (12)    |
|-------------|----------|------------|----------------------|-----------|
| Document ID | Revision | Date       | Document Category    | Page (of) |
