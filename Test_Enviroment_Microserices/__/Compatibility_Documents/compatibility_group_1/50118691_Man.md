...
|           |     | 6.2.1                                                 | Playing Back Frame by Frame 96                            |  |
...
| 9.14       | Audio Exception Detection  137                    |  |
...
| 12.1.3 Manually Creating Array  174                         |  |
...
| 16.5<br>Managing User Accounts 218         |  |
|--------------------------------------------|--|
...
| 5                                               |                  | Alphanumeric Buttons                               | Switches between different channels in playback mode.           |
...
The keys on the remote control closely resemble the ones on the front panel. See Table 1. 2. Table 1. 2 Description of the Soft Keyboard Icons
...
Figure 2. 19 Quick Adding IP Camera Interface
...
| View<br>General        | Channel-Zero Encoding |                      |         |               |        |
|------------------------|-----------------------|----------------------|---------|---------------|--------|
...
| Frame Rate               | Full Frame      | 62 |
| Max. Bitrate Mode        | General         | V  |
| Max. Bitrate (Kbps) (max | 1024            | V  |
...
| Camera          | [D2] IPCamera 01 |   |               |   |
|-----------------|------------------|---|---------------|---|
| Parameter Type  | Continuous       |   | Event         |   |
| Resolution      | 704*480(4CIF)    | 2 | 704*480(4CIF) |   |
| Picture Quality | Medium           |   | - Medium      | 0 |
| Interval        | 2s               |   | ~ 2s          |   |
...
- 4) Click **Edit** button or click on the color icon under the edit button and draw the schedule line on the panel. **Edit the schedule:**
	- I. In the message box, you can choose the day to which you want to set schedule.

|                |             | Edit        |                 |
|----------------|-------------|-------------|-----------------|
| Weekday        | Mon         |             |                 |
| All Day        | 网           | Type        | Continuous      |
| Start/End Time | 00:00-24:00 | Type<br>0   | Continuous<br>> |
| Start/End Time | 00:00-00:00 | 9<br>Type   | Continuous      |
| Start/End Time | 00:00-00:00 | 0<br>Type   | Continuous      |
| Start/End Time | 00:00-00:00 | 0<br>Type   | Continuous      |
| Start/End Time | 00:00-00:00 | 0<br>Type   | Continuous      |
| Start/End Time | 00:00-00:00 | 0<br>Type   | Continuous<br>> |
| Start/End Time | 00:00-00:00 | 9<br>Type   | Continuous      |
| Start/End Time | 00:00-00:00 | 0<br>Type   | Continuous      |
|                |             |             |                 |
...
- **3.** Edit the Motion Detection Record Schedule. For the detailed information of schedule configuration, see *Chapter Configuring Recording and Capture* Schedule*.*
...
- **3.** Edit the Alarm triggered record in the Record/Capture Schedule setting interface. For the detailed information of schedule configuration, see *Chapter Configuring Recording and Capture* Schedule*.*
...
| Record                                                       |                      |
|--------------------------------------------------------------|----------------------|
| IP Camera                                                    | ON D1<br>ON D2<br>D3 |
| ON Recording by schedule<br>on Recording by manual operation |                      |
| Continuous                                                   | 泰                    |
| Motion Detection                                             | 泰                    |
...
|----|--------------------------------------------------------------|--|
| 2) | Click the status button before camera number to change<br>to |  |
| 3) | Disable continuous capture.                                  |  |
| 4) | Click the status button to change<br>to                      |  |
|    |                                                              |  |

Green icon means that the channel is configured the capture schedule. After rebooting, all the continuous capture will be canceled.
...
|     | Holiday Settings |                |                     |              |                                    |  |
|-----|------------------|----------------|---------------------|--------------|------------------------------------|--|
| No. | Holiday Name     | Status         | Start Date          | End Date     |                                    |  |
| 1   | Holiday1         | Enabled 1 Jan  |                     | 1 Jan        |                                    |  |
| 2   | Holiday2         |                | Enabled 1st Tue.Jan | last Wed.Jan | 1                                  |  |
| 3   | Holiday3         | Disabled 1.Jan |                     | 1 Jan        | 12                                 |  |
| 4   | Holiday4         | Disabled 1 Jan |                     | 1 Jan        |                                    |  |
| 5   | Holiday5         | Disabled 1 Jan |                     | 1.Jan        | 日 12 12 12 12 12 12 12 12 12 12 12 |  |
| 6   | Holiday6         | Disabled 1 Jan |                     | 1.Jan        |                                    |  |
| 7   | Holiday 7        | Disabled 1.Jan |                     | 1 Jan        |                                    |  |
...
- **3.** Enter Record/Capture Schedule settings interface to edit the holiday recording schedule. See *Chapter 6.2 Configuring Recording and Capture* Schedule*.*
...
| Capacity | Status     | Property | Type |       |       |                              |
|----------|------------|----------|------|-------|-------|------------------------------|
|          | 5 931.51GB | Normal   | RW   | Local | 846GB | Free Space Gr  Edit D<br>1 3 |
...
|   | HDD Information |        |          |       |                         |   |  |
|---|-----------------|--------|----------|-------|-------------------------|---|--|
| - | Capacity        | Status | Property | Type  | Free Space  Gr  Edit D. |   |  |
|   | 5 931.51GB      | Normal | RW       | Local | 846GB                   | F |  |
...
| IP Camera           | v D1<br>v Da |       |  | ZD2 ZD3 ZD4 ZD5 ZD5 ZD6 ZD7<br>ZD10 ZD11 ZD12 ZD13 ZD13 ZD14 ■D15 ■D16 |  | v D8 |  |
|                     |              |       |  |                                                                        |  |      |  |
...
| D3              | 12-17-2013 17:49:51--20:24:12 |             | 199,971KB 9     |           |                                    |                     |
| D4              | 12-17-2013 17:49:51--20:24:12 |             | 199,628KB       | 0         |                                    |                     |
| D7              | 12-17-2013 17:49:51-20:24:12  |             | 123,343KB       | C         |                                    |                     |
| D7              | 12-25-2013 17:13:48--17:32:22 |             | 45,401KB        |           |                                    |                     |
| D7              | 12-26-2013 14:37:54--15:39:52 |             | 242,565KB @     |           |                                    |                     |
|                 |                               |             |                 |           | HDD: 4<br>Start time:<br>End time: | 12-17-2013 17:49:51 |
| Total: 5 P: 1/1 |                               |             |                 |           |                                    | 12-17-2013 20:24:12 |
| Total size: OMB |                               |             | Export All      |           | Export                             | Cancel              |
...
| Normal                   |           |                                            |           |          |     |                                |     |              |
|--------------------------|-----------|--------------------------------------------|-----------|----------|-----|--------------------------------|-----|--------------|
| IP Camera                | 201<br>Da | DD2 2D3                                    | DD10 ZD11 | 204      | 205 | 206<br>2 D12 2 D13 2 D14 0 D15 | 207 | 208<br>P D16 |
| Start/End time of record |           | 06-27-2013 08:53:36 -- 06-27-2013 16:41:08 |           |          |     |                                |     |              |
| Record Type              |           | All                                        |           |          |     |                                |     |              |
| File Type                |           | All                                        |           |          |     |                                |     |              |
| Start Time               |           | 06-27-2013                                 |           | 00:00:00 |     |                                |     |              |
| End Time                 |           | 06-27-2013<br>23:59:59                     |           |          |     |                                | 0   |              |
...
|--------|-----------------------|--------|---------------------|--------|-----------------|
| /      | Audio on/ Mute        | /      | Start/Stop clipping |        | Capture Picture |
|        |                       |        |                     |        | Add customized  |
|        | Lock File             |        | Add default tag     |        | tag             |
|        | File management       |        |                     |        |                 |
|        | for video clips,      |        | Reverse play/ Pause |        |                 |
|        | captured pictures,    | /      |                     |        | Stop            |
|        | locked files and tags |        |                     |        |                 |

| Button | Operation           | Button | Operation      | Button | Operation    |
|--------|---------------------|--------|----------------|--------|--------------|
|        | Digital Zoom        |        | 30s forward    |        | 30s reverse  |
| /      | Pause / Play        |        | Fast forward   |        | Previous day |
|        | Slow forward        |        | Full Screen    |        | Exit         |
|        | Next day            |        | Save the clips |        | Process bar  |
| /      | Scaling up/down the |        |                |        |              |
|        | time line           |        |                |        |              |
...
| D1              | TAG |                  |             | 12-08-2014 15:52:12 | 17   | 道      |
| D1              | A1  |                  |             | 12-08-2014 15:52:15 | 17   | 直      |
| D1              | A2  |                  |             | 12-08-2014 15:52:18 | 看    | 通      |
|                 |     |                  |             |                     |      |        |
| Total: 3 P: 1/1 |     |                  |             |                     |      |        |
|                 |     |                  |             |                     |      | Cancel |
...
|        | line crossing       |        | for the intrusion  |        | for the intrusion  |            |
|        | detection           |        | detection          |        | detection          |            |
|        | Set full screen for |        |                    |        |                    | Start/Stop |
|        | motion detection    |        | Clear all          | /      | clipping           |            |
|        | File management for |        |                    | /      | Pause playing /    |            |
|        | video clips         |        | Stop playing       |        | Play               |            |
|        | Smart settings      |        |                    |        | Filter video files |            |
|        |                     |        | Search matched     |        | by setting the     |            |
|        |                     |        | video files        |        | target characters  |            |
...
| Log Search                            |            |            |          |      |     |
|---------------------------------------|------------|------------|----------|------|-----|
| Start Time                            | 27-01-2015 |            | 00:00:00 |      | 0   |
| End Time                              | 28-01-2015 | I          | 23:59:59 |      | 0   |
| Major Type                            | All        |            |          |      | 4-1 |
| Minor Type                            |            |            |          | 1    |     |
| Alarm Input                           |            |            |          |      |     |
| Alarm Output                          |            |            |          |      |     |
...
| 1             | A Exception       | 27-01-2015 10:02:58 HDD Error             |                     | N/A            |    | S       | == |  |
| 2             | Exception         | 27-01-2015 10:02:58 HDD Error             |                     | NA             |    | 6       |    |  |
...
| 6             | Exception         | 27-01-2015 10:03:13 Record/Capture  N/A   |                     |                | O  | S       |    |  |
| 7             | Exception         | 27-01-2015 10:03:13                       | Record/Capture  N/A |                | O  | 0       |    |  |
| 8             | A Exception       | 27-01-2015 10:03:13 Record/Capture  N/A   |                     |                | O  | 0       |    |  |
| 9             | T Operation       | 27-01-2015 11:06:34 Local Operation : N/A |                     |                |    | 6       |    |  |
...
- **5.** Choose a picture you want to view and click button.
...
Figure 6. 21 Picture Playback Toolbar

- **Button Function Button Function Button Function Button Function** Play reverse Play Previous picture Next picture
...
Play video files frame by frame, in case of checking image details of the video when abnormal events happen. *Steps:* 
...
We use the interface of DS-7700NI-ST series (unless stated) as example to describe the following settings.
...
| 60 F<br>RD10 ED11<br>ZD12<br>ED13<br>2 D14<br>2 D17<br>D18 2 D19<br>2 D20<br>PD21<br>ZD22<br>D26 D27 DD28<br>6202<br>D30<br>ZD25<br>2034 D35<br>D36<br>D37 0 D38<br>- D33<br>D42 DA2 BD43 2 D44<br>2 D45<br>D46 DD47 2 D48<br>VD41<br>2 049<br>D50 D50 BD51 ZD52 ZD53 ZD54 ZD56 ZD56<br>09-12-2014 09:38:58 -- 12-11-2014 11:20:12 | 2015 8 D16<br>D23 D24<br>2031 ZD32<br>D39 D D40 |  |  |  |  |  |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|--|--|--|--|--|
|                                                                                                                                                                                                                                                                                                                                    |                                                 |  |  |  |  |  |
|                                                                                                                                                                                                                                                                                                                                    |                                                 |  |  |  |  |  |
|                                                                                                                                                                                                                                                                                                                                    |                                                 |  |  |  |  |  |
|                                                                                                                                                                                                                                                                                                                                    |                                                 |  |  |  |  |  |
| Start/End time of record                                                                                                                                                                                                                                                                                                           |                                                 |  |  |  |  |  |
|                                                                                                                                                                                                                                                                                                                                    |                                                 |  |  |  |  |  |
|                                                                                                                                                                                                                                                                                                                                    |                                                 |  |  |  |  |  |
| All<br>Record Type                                                                                                                                                                                                                                                                                                                 |                                                 |  |  |  |  |  |
| File Type<br>All                                                                                                                                                                                                                                                                                                                   |                                                 |  |  |  |  |  |
| 12-25-2014<br>00:00:00:00<br>Start Time                                                                                                                                                                                                                                                                                            | C                                               |  |  |  |  |  |
| 12-25-2014<br>23:59:59<br>End Time                                                                                                                                                                                                                                                                                                 | 10                                              |  |  |  |  |  |
...
|                 | Export             |           |                     |   |             |   |
|-----------------|--------------------|-----------|---------------------|---|-------------|---|
| Device Name     | USB Flash Disk 1-1 |           | ".mp4               | > | Refresh     |   |
| Name            | Size Type          | Edit Date |                     |   | Delete Play |   |
| ch09_2014102916 | 486.88MB File      |           | 10-29-2014 19:10:56 |   | m           | 0 |
| ch13_2014091909 | 2707.10KB File     |           | 09-19-2014 15:42:20 |   | m           | O |
|                 |                    |           |                     |   |             |   |
| Free Space      | 1412.00MB          |           |                     |   |             |   |
|                 | New Folder         | Format    | Export              |   | Cancel      |   |
...
|                  | Export             |                     |        |    |             |
|------------------|--------------------|---------------------|--------|----|-------------|
| Device Name      | USB Flash Disk 1-1 | 2                   | .mp4   | ﻣﺔ | Refresh     |
| Name             | Size Type          | Edit Date           |        |    | Delete Play |
| ch01_2014121009. | 430.15MB File      | 12-25-2014 14:33:18 |        | u  | (C):        |
| ch09_2014102916  | 486.88MB File      | 10-29-2014 19:10:56 |        | m  | 0           |
| ch13_2014091909  | 2707.10KB File     | 09-19-2014 15:42:20 |        | 10 | 0           |
| Free Space       | 981.85MB           |                     |        |    |             |
|                  |                    |                     |        |    | Cancel      |
|                  | New Folder         | Format              | Export |    |             |
...
| 60FF<br>- D10<br>D11 ED12 ED13 ED13 ED14 ED15 ED16<br>ZD17<br>D18 ZD19 ZD20 ZD21 ZD22 ZD23 ZD24<br>D26 BD26 EDD27 DD28 BD29 ZD30 WD31 WD32<br>D34 D34 D35 WD36 ZD37 ZD38 ZD39 ZD40<br>- D33<br>V D41<br>D42 D43 D43 D44 ZD45 DD46 DD47 ZD48<br>2 D49<br>D50 ZD51 ZD51 ZD52 ZD53 ZD54 ZD56 ZD56<br>09-12-2014 09:38:58 -- 12-11-2014 11:20:12<br>All<br>All | IP Camera   | VD1 | D2         | 203 | D4 | 205 | DOG         | D7 DD8 |   |  |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----|------------|-----|----|-----|-------------|--------|---|--|
|                                                                                                                                                                                                                                                                                                                                                            |             |     |            |     |    |     |             |        |   |  |
|                                                                                                                                                                                                                                                                                                                                                            |             |     |            |     |    |     |             |        |   |  |
|                                                                                                                                                                                                                                                                                                                                                            |             |     |            |     |    |     |             |        |   |  |
...
|                                                                                                                                                                                                                                                                                                                                                            | Record Type |     |            |     |    |     |             |        |   |  |
|                                                                                                                                                                                                                                                                                                                                                            | File Type   |     |            |     |    |     |             |        |   |  |
|                                                                                                                                                                                                                                                                                                                                                            | Start Time  |     | 12-25-2014 |     |    |     | 00:00:00:00 |        | 5 |  |
| 12-25-2014<br>1 23:59:59                                                                                                                                                                                                                                                                                                                                   | End Time    |     |            |     |    |     |             |        | 0 |  |
...
| D1              | 12-10-2014 09:15:59 -  | 430.14MB O    | ों         |        |      |
| D1              | 12-10-2014 10:19:00 -- | 1011.18MB @   | S          |        |      |
| D1              | 12-10-2014 12:28:24 -- | 84.68MB @     | 9          |        |      |
...
| Device Name            | USB Flash Disk 1-1 |                     | *.mp4  |   | Refresh     |
| Name                   | Size Type          | Edit Date           |        |   | Delete Play |
| ch01_2014121009<br>ill | 430.15MB File      | 12-25-2014 14:33:18 |        | m | -           |
| ch09 2014102916        | 486.88MB File      | 10-29-2014 19:10:56 |        | m | -           |
| ch13_2014091909        | 2707.10KB File     | 09-19-2014 15:42:20 |        | m | -           |
| = d01_sd_ch01_141      | 25.90MB File       | 12-25-2014 17:34:58 |        | m | -           |
|                        |                    |                     |        |   |             |
| Free Space             | 955.94MB           |                     |        |   |             |
|                        | New Folder         | Format              | Export |   | Cancel      |
...
|----------------------|-------|------------|---------|-------|-------|------------------|--------|-------|---|--|
| Major Type           |       | Motion     |         |       |       |                  |        |       |   |  |
| Start Time           |       | 12-10-2014 |         |       | I     | 00:00:00         |        |       | C |  |
| End Time<br>Pre-play |       | 12-10-2014 |         |       | 1     | 23:59:59         |        |       |   |  |
|                      |       | 30s        |         |       |       |                  |        |       |   |  |
| Post-play            |       | 30s        |         |       |       |                  |        |       |   |  |
| IP Camera            | 2D1   | ZD2        | DD3     | DA    | DS    | DOG              | 207    | 208   | A |  |
|                      | ZD9   | VD10       | ZD11    | ZD12  | ZD13  | ZD14             | V D15  | V D16 |   |  |
|                      | 2017  | 2 D18      | 2019    | DD20  |       | D21 ZD22         | 2 D23  | 2 D24 |   |  |
|                      | 2025  | ZD26       | 2027    | 2028  | 2029  | D30              | VD31   | 2 D32 |   |  |
|                      | ZD33  | D34        | 2 D35   | 2 D36 | D37   | D38              | ZD39   | D40   |   |  |
|                      | 7 D41 | 2 042      | 2 D43   | 2 D44 | D D45 | 2046             | 2047   | 2048  |   |  |
|                      | Z D49 |            | D50 DS1 |       |       | D52 DS2 DS3 DD54 | 2 055  | 2 056 |   |  |
|                      |       |            |         |       |       |                  |        |       |   |  |
|                      |       |            |         |       |       |                  |        |       |   |  |
|                      |       |            |         |       |       |                  |        |       |   |  |
|                      |       |            |         |       | ﻳ     |                  | Search | Back  |   |  |
...
| D1              | D1             | 6 | 12-08-2014 20:33:18 -- | 25.89MB @   |        |      |
| D1              | D1             | 6 | 12-10-2014 11:18:13 -- | 8593.30KB @ |        | >    |
| Total: 2 P: 1/1 |                |   |                        |             |        |      |
| Total size: OB  |                |   |                        | Export All  | Export | Back |
...
|                 | 12-05-2014 18:18:20-18:18:22  |             | 1569 85KB       |                                                                                                                              |
| ID1             | 12-05-2014 18:18:24--18:18:25 |             | 786.86KB        |                                                                                                                              |
| Total: 2 P: 1/1 |                               |             |                 | Camera with clip recording: 1<br>Start time:<br>12-05-2014 18:18:20<br>End time:<br>12-05-2014 18:18:22<br>Selected clips: 0 |
| Total size: 0B  |                               |             | Export All      | Export<br>Cancel                                                                                                             |

Figure 7. 11 Video Clips or Captured Pictures Export Interface

- **7.** Export the video clips or captured pictures in playback. Please refer to step5 of *Chapter 7.1.2 Backing up by Normal Video Search* for details.
...
| Device Name            | USB Flash Disk 1-1 |                     | ".mp4  |   | Refresh     |
| Name                   | Size Type          | Edit Date           |        |   | Delete Play |
| ch01_2014121009<br>11  | 430.15MB File      | 12-25-2014 14:33:18 |        | m |             |
| ch09_2014102916<br>ili | 486.88MB File      | 10-29-2014 19:10:56 |        | m |             |
| ch13_2014091909<br>测   | 2707.10KB File     | 09-19-2014 15:42:20 |        | m |             |
| d01_sd_ch01_141<br>izz | 25.90MB File       | 12-25-2014 17:34:58 |        | m |             |
|                        |                    |                     |        |   |             |
| Free Space             | 955.94MB           |                     |        |   |             |
|                        | New Folder         | Format              | Export |   | Cancel      |
...
|      | Work Mode<br>· Normal Mode          |              | O Hot Spare Mode  |                |            |
|------|-------------------------------------|--------------|-------------------|----------------|------------|
|      | Device List                         |              |                   |                |            |
| INo. |                                     | IP Address   |                   |                |            |
| 1    |                                     | 172.6.23.163 |                   |                |            |
...
| 167 | 172.6.23.163          | Online            | No record      | 103    |
...
| Video Tampering Detection Settings |                        |             |   |
|------------------------------------|------------------------|-------------|---|
|                                    |                        |             | 2 |
| D                                  |                        |             |   |
|                                    | Settings               | 播           |   |
|                                    | Sensitivity            |             |   |
|                                    | Clear                  |             |   |
|                                    | Enable Video Tampering | IP Camera 1 |   |
...
Send an email with alarm information to a user or users when an alarm is detected. Please refer to *Chapter* 11.2.10 for details of Email configuration.
...
- 1. Enter the Face Detection settings interface. Menu> Camera> VCA
...
| Enable Face Recog |                         |                                                 |           |                       |           | Save        |  |
|-------------------|-------------------------|-------------------------------------------------|-----------|-----------------------|-----------|-------------|--|
| Camera            |                         | [D2] Camera 01                                  |           |                       |           | Save VCA Pi |  |
| Face Det          | Vehicle                 | Line Cro  Intrusion  Region<br>Region           |           |                       | Loitering | People G    |  |
| Fast Mo           | Parking                 | Unattend  Object R  Audio Ex<br>Defocus  Sudden |           |                       |           | PIR Alarm   |  |
| Enable            |                         | >                                               |           |                       |           |             |  |
| 都<br>Settings     |                         |                                                 |           |                       |           |             |  |
| Rule<br>1         |                         |                                                 |           | Rule Settings         |           |             |  |
|                   | 03-26 2015 Thu 19:31:44 |                                                 | Canera 01 | Draw Qua<br>Clear All |           |             |  |
|                   |                         |                                                 |           |                       |           |             |  |
...
| Enable Face Recog       |                                                    |                                               |                               |          | Save          |           |
| Camera                  | [D2] Camera 01                                     |                                               |                               |          | Save VCA Pi   |           |
| Face Det<br>Vehicle     | Line Cro  Intrusion  Region<br>Region<br>Loitering |                                               |                               | People G |               |           |
| Fast Mo<br>Parking      |                                                    | Unattend  Object R  Audio Ex  Defocus  Sudden |                               |          |               | PIR Alarm |
| Enable                  |                                                    |                                               |                               |          |               |           |
| Settings                | Blacklist<br>载                                     | * Whitelist                                   | * Others                      |          |               |           |
| Rule                    | 1                                                  |                                               |                               |          | Rule Settings |           |
| 03-26-2015 Thu 19:19:30 |                                                    |                                               | Blacklist & Whit<br>Draw Line |          | Import/Export |           |
|                         |                                                    | Draw Qua                                      | No. Plate No.                 |          | Type          |           |
| *1 *<br>#0#             | #1#<br>Canera                                      | Clear All                                     |                               |          |               |           |
|                         |                                                    |                                               |                               |          | Back          |           |
...
|                  | Rule Settings             |              |
|------------------|---------------------------|--------------|
| Basic<br>Picture | Overlay Content           |              |
| No.              | 1                         |              |
...
| Settings          |             | 赛                                     |           |                                    |        |               |           |
| Rule              |             | 1                                     |           |                                    |        | Rule Settings |           |
| #1#               | 41 :40<br>A | 0<br>11                               |           | Draw Line<br>Draw Qua<br>Clear All |        |               |           |
|                   |             |                                       |           |                                    |        | Apply         | Back      |
...
| Sensitivity                |               | 50<br><> |
| Sound Intensity Threshold  |               | C<br>50  |
...
Please refer to *Section 9.2* 错误*!*未找到引用源。for configuring the face detection.
...
| Face Search |     |            |    |    |    |          |        |      |   |
|-------------|-----|------------|----|----|----|----------|--------|------|---|
| IP Camera   | ZD1 | ZD2        | D3 | DA | D5 | DOG      | DD7    | DD8  |   |
| Start Time  |     | 11-12-2014 |    |    |    | 00:00:00 |        |      | 9 |
| End Time    |     | 02-12-2015 |    |    | I  | 23:59:59 |        |      | 0 |
|             |     |            |    |    |    |          |        |      |   |
|             |     |            |    |    |    |          |        |      |   |
|             |     |            |    |    |    |          |        |      |   |
|             |     |            |    |    |    |          |        |      |   |
...
| ZD1             | 12-08-2014 20:33:17 | -           | 0          |                 |      |
| ID1             | 12-10-2014 11:18:11 | -           | 0          |                 |      |
| ID1             | 12-10-2014 11:18:11 | 1           | 0          |                 |      |
|                 |                     |             |            |                 |      |
|                 |                     |             |            | 20:33:15<br>33% |      |
|                 |                     |             |            | =               | >    |
|                 |                     |             |            |                 |      |
...
Please refer to 错误*!*未找到引用源。错误*!*未找到引用源。for the operation of exporting files.
...
| Behavior Search |    |            |      |      |     |          |        |      |   |
|-----------------|----|------------|------|------|-----|----------|--------|------|---|
| IP Camera       | DI | D22        | 2 D3 | 2 D4 | DD5 | DD6      | 207    | D8   |   |
| Start Time      |    | 11-12-2014 |      |      |     | 00:00:00 |        |      | 0 |
| End Time        |    | 02-12-2015 |      |      | 编   | 23:59:59 |        |      | இ |
| Type            |    | AII        |      |      |     |          |        |      | < |
|                 |    |            |      |      |     |          |        |      |   |
|                 |    |            |      |      |     |          | Search | Back |   |
...
| D3              | 12-12-2014 12:32:36 | Region Exiting Detection | (6)        |                |
| D3              | 12-12-2014 15:10:44 | Region Exiting Detection | 0          |                |
| D3              | 12-12-2014 15:11:21 | Intrusion Detection      | 0          |                |
...
| D3              | 12-12-2014 17:14:40 | Region Exiting Detection | 0          |                |
|                 |                     |                          |            |                |
| Total: 8 P: 1/1 |                     |                          |            |                |
...
| Plate Search |     |            |     |     |     |          |     |      |   |
|--------------|-----|------------|-----|-----|-----|----------|-----|------|---|
| ZIP Camera   | ZD1 | ZD2        | ZD3 | ▽D4 | VD5 | ZD6      | ZD7 | ZD8  |   |
| Start Time   |     | 03-27-2015 |     |     | 汇   | 00:00:00 |     |      | 0 |
| End Time     |     | 03-27-2015 |     |     | 汇   | 23:59:59 |     |      | Q |
| Country      |     | All        |     |     |     |          |     |      |   |
| Plate No.    |     |            |     |     |     |          |     |      |   |
|              |     |            |     |     |     |          |     |      |   |
|              |     |            |     |     |     |          |     |      |   |
...
The heat map function must be supported by the connected IP camera and the corresponding configuration must be
...
| General<br>PPPOE     | DONS                | NTP  | Email               | SNMP                         | NAT | More Settings  |                                    |     |
|----------------------|---------------------|------|---------------------|------------------------------|-----|----------------|------------------------------------|-----|
| Working Mode         |                     |      | Net Fault-tolerance |                              |     |                |                                    | >   |
| Select NIC           |                     |      | bondo               |                              |     |                |                                    | ( ) |
| NIC Type             |                     |      |                     | 10M/100M/1000M Self-adaptive |     |                |                                    | C   |
| Enable DHCP          |                     |      | 1                   |                              |     |                |                                    |     |
| IPv4 Address         | 10 . 16<br>.1       | .49  |                     |                              |     | IPv6 Address 1 | fe80 :: 8ee 7 :48ff :fe45 :2961/64 |     |
...
Two 10M/100M/1000M NIC cards are provided and it allows the device to work in the Multi-address, Load Balance and Net-fault Tolerance modes.
...
| NIC Type             | 10M/100M/1000M Self-adaptive          |   |
| Enable DHCP          |                                       |   |
| IPv4 Address         | 172 .6<br>.21 .159                    |   |
| IPy4 Subnet Mask     | 255 .255 .255 .0                      |   |
| IPv4 Default Gateway | 172 .6<br>.21 .1                      |   |
| IPv6 Address 1       | fec0::a:240:48ff:fe62:dcd/64          |   |
| IPv6 Address 2       | 2002:ac06:1578:a:240:48ff:fe62:dcd/64 |   |
| IPv6 Default Gateway |                                       |   |
| MAC Address          | 00:40:48:62:0d:cd                     |   |
| MTU(Bytes)           | 1200                                  |   |
| Preferred DNS Server |                                       |   |
| Alternate DNS Server |                                       |   |
| Main NIC             | LAN1                                  | > |
...
### **11.2.1Configuring PPPoE Settings**
...
Figure 11. 4 IPServer Settings Interface
...
| Area/Country       | Custom            | > | V |
| Server Address     |                   |   |   |
| Device Domain Name |                   |   |   |
| Status             | DDNS is disabled. |   |   |
| User Name          | 123.gcip.net      |   |   |
| Password           | 发 发 发 发 发 发 发     |   |   |
...
Figure 11. 9 Login Interface

Figure 11. 10 Register an Account

Figure 11. 11 Register the Device
...
Figure 11. 12 Access Device via iVMS4200

- **5.** Click the **Apply** button to save and exit the interface.
### **11.2.3Configuring NTP Server**
...
- **2.** Select the **NTP** tab to enter the NTP Settings interface, as shown in Figure 11. 13.
...
Figure 11. 13 NTP Settings Interface
...
- **2.** Select the **SNMP** tab to enter the SNMP Settings interface, as shown in Figure 11. 14.
...
Figure 11. 14 SNMP Settings Interface
...
### **11.2.5Configuring Remote Alarm Host**
...
- **2.** Select the **More Settings** tab to enter the More Settings interface, as shown in Figure 11. 15.
- **3.** Set **Multicast IP**, as shown in Figure 11. 16. When adding a device to the Network Video Surveillance
...
### **11.2.8Configuring Server and HTTP Ports**
...
|--------------|---------------------------------------|
| HTTP Port    | 80                                    |
| Multicast IP | AGO MODERS POSTERS SO<br>239.221.2.78 |
...
Figure 11. 20 Create Self-signed Certificate
...
| Property              | Subject: C=CN, H/IP=172.6.23.110                    |        |  |
|                       | Issuer: C=CN, H/IP=172.6.23.110                     |        |  |
|                       | Validity: 2013-06-28 10:42:40 ~ 2013-06-30 10:42:40 |        |  |

Figure 11. 21 Installed Certificate Property
...
- **2.** Set the IPv4 Address, IPv4 Subnet Mask, IPv4 Gateway and the Preferred DNS Server in the Network Settings menu, as shown in Figure 11. 22.

| General<br>PPPOE     | DONS<br>NTP         | Email                        | SNMP<br>NAT | More Settings  |                                    |
|----------------------|---------------------|------------------------------|-------------|----------------|------------------------------------|
| Working Mode         |                     | Net Fault-tolerance          |             |                | < C                                |
| Select NIC           |                     | bond0                        |             | C              |                                    |
| NIC Type             |                     | 10M/100M/1000M Self-adaptive |             | C              |                                    |
| Enable DHCP          |                     | 1                            |             |                |                                    |
| IPv4 Address         | .16 .1<br>10<br>.49 |                              |             | IPv6 Address 1 | fe80 :: 8ee 7 :48ff :fe45 :2961/64 |
| IPv4 Subnet          | 255 . 255 . 255 . 0 |                              |             | IPv6 Address 2 |                                    |
| IPv4 Default G       | 10 .16 .1           | .254                         |             | IPv6 Default G |                                    |
| MAC Address          |                     | 8cte7:48:45:29:61            |             |                |                                    |
| MTU(Bytes)           |                     | 1500                         |             |                |                                    |
| Preferred DNS Server |                     |                              |             |                |                                    |
| Alternate DNS Server |                     |                              |             |                |                                    |
| Main NIC             |                     | LAN1                         |             |                |                                    |
...
Figure 11. 22 Network Settings Interface

- **3.** Click **Apply** to save the settings.
- **4.** Select the Email tab to enter the Email Settings interface.

| General<br>РРРОЕ   | DDNS<br>NTP<br>Email | SNMP<br>NAT | More Settings |
|--------------------|----------------------|-------------|---------------|
| Enable Se          |                      | SMTP Ser    |               |
| User Name          |                      | SMTP Port   | ટર            |
| Password           |                      | Enable SSL  | ਨੀ            |
| Sender             |                      |             |               |
| Sender's Address   |                      |             |               |
| Select Receivers   | Receiver 1           |             | V             |
| Receiver           |                      |             |               |
| Receiver's Address |                      |             |               |
| Enable Att  ■      |                      | Interval    | 2s<br>>       |

Figure 11. 23 Email Settings Interface
...
- **7.** You can click **Test** button to test whether your Email settings work. The corresponding Attention message box will pop up. Refer to Figure 11. 24.

| Attention                   | Attention                                                                          |  |  |
|-----------------------------|------------------------------------------------------------------------------------|--|--|
| Email test succeeded.<br>OK | Failed to send test email, please check<br>the parameters or network status.<br>OK |  |  |

Figure 11. 24 Email Testing Attention
...
| Server Port  | 19   | 8000          | 0.0.0.0            | 8000 | Inactive |         |
| HTTP Port    | 17   | 80            | 0.0.0.0            | 80   | Inactive |         |
| RTSP Port    | 17   | 554           | 0.0.0.0            | 554  | Inactive |         |
| HTTPS Port   | 19   | 443           | 0.0.0.0            | 443  | Inactive |         |
|              |      |               |                    |      |          |         |
|              |      |               |                    |      |          | Refresh |

Figure 11. 25 UPnP™ Settings Interface
...
| Mapping Type     |      | Auto          |                    |      |        |         |
| Port Type        | Edit | External Port | Mapping IP Address | Port | Status |         |
| Server Port      | 12   | 43728         | 172 6 21 31        | 8000 | Active |         |
| HTTP Port        | 17   | 31397         | 172.6.2131         | 80   | Active |         |
| RISP Port        | 12   | 59826         | 172.6.21.31        | 554  | Active |         |
| HTTPS Port       | 7    | 31231         | 172.6.21.31        | 443  | Active |         |
|                  |      |               |                    |      |        | Refresh |

Figure 11. 26 UPnP™ Settings Finished-Auto
...
| Enable UPnP            |      | )             |                    |      |        |         |
|------------------------|------|---------------|--------------------|------|--------|---------|
| Manual<br>Mapping Type |      |               |                    |      |        |         |
| Port Type              | Edit | External Port | Mapping IP Address | Port | Status |         |
| Server Port            | 12   | 8002          | 1726.21.31         | 8000 | Active |         |
| HTTP Port              | 12   | 80            | 172.6.21.31        | 80   | Active |         |
| RTSP Port              | 12   | 554           | 172.6.21.31        | 554  | Active |         |
| HTTPS Port             | 171  | 443           | 172.6.21.31        | 443  | Active |         |
|                        |      |               |                    |      |        |         |
|                        |      |               |                    |      |        | Refresh |

Figure 11. 28 UPnP™ Settings Finished-Manual
...
Figure 11. 29 External Port Settings Dialog Box
...
Figure 11. 30 Setting Virtual Server Item
...
### **11.2.12 Configuring High-speed Download**
...
If you enable the high-speed download function, the outgoing bandwidth of the device will be increased by 40Mbps and the local menu operation will be affected. It is recommended to disable this function after finishing the remote downloading of record files.
...
### **11.2.13 Configuring Virtual Host**
...
- **1.** Enter the Advanced settings interface, as shown in the Figure 11. 33.
...
Figure 11. 33 Advanced Settings Interface

- **2.** Check the checkbox of the **Enable Virtual Host**.
- **3.** Click the **Save** button to save the setting.
- **4.** Enter the IP camera management interface of NVR. The Connect column appears on the right-most side of the camera list, as shown in the Figure 11. 34.

Configuration > Remote Configuration > Camera Management > IP Camera

| IP Camera   |                   |  |             |           |                 |                           |           |                        |
|-------------|-------------------|--|-------------|-----------|-----------------|---------------------------|-----------|------------------------|
| Add         | Modify            |  | Delete      | Quick Add | Custom Protocol |                           |           |                        |
| Channel No. | IP Camera Address |  | Channel No. |           | Management Port | Status                    | Protocol  | Connect                |
| DD1         | 172.6.22.84       |  |             |           | 80              | Online                    | ONVIE     | http://172.6.22.84:80  |
| D02         | 172.6.23.123      |  |             |           | 8000            | Offline(Network Abnormal) | HIKVISION | http://172.6.23.123:80 |
| DO3         | 172.6.10.13       |  |             |           | 8000            | Online                    | HIKVISION | http://172.6.10.13:80  |
| D04         | 172.6.23.2        |  |             |           | 8000            | Online                    | HIKVISION | http://172.6.23.2:80   |

![](_page_165_Figure_5.jpeg)

- **5.** Click the link and the page of IP camera management appears.
### **11.2.14 Configuring Telnet**

### *Purpose:*

Telnet function provides an easy way to get access to the NVR. You can see the advanced information about the device by inputting command; as well the configuration can also be realized through telnet connection. *Steps:*

- **1.** Enter the Advanced settings interface, as shown in the Figure 11. 33. Configuration > Remote Configuration > Network Settings > Advanced
- **2.** Check the checkbox of the **Enable Telnet**.
- **3.** Click the **Save** button to save the setting.
- **4.** You can open the Command Prompt window in your PC, and input "telnet *IP Address*" to connect with the NVR, as shown in the figure below.

#### *Example:*

If the IP address of the NVR is 192.0.0.64, you can input "telnet 192.0.0.64" and then press Enter to connect to the NVR.

![](_page_165_Picture_17.jpeg)

Figure 11. 35 Connect to NVR

![](_page_165_Picture_19.jpeg)

The telnet function turns invalid after the device shutting down or rebooting, you have to enable it again if
...
Figure 11. 36 Network Traffic Interface
...
- **2.** Click the **Network Detection** tab to enter the Network Detection menu, as shown in Figure 11. 37.

| Select NIC            | LAN1        |           | > |         |
|-----------------------|-------------|-----------|---|---------|
| Destination Address   | 172.6.23.6  |           |   | Test    |
| Network Packet Export |             |           |   |         |
| Device Name           |             |           | 2 | Refresh |
| LAN1                  | 172.6.21.64 | 2,789Kbps |   | Export  |

![](_page_167_Figure_10.jpeg)

- **3.** Enter the destination address in the text field of **Destination Address**.
- **4.** Click **Test** button to start testing network delay and packet loss. The testing result pops up on the window. If the testing is failed, the error message box will pop up as well. Refer to Figure 11. 38.

![](_page_167_Figure_13.jpeg)

Figure 11. 38 Testing Result of Network Delay and Packet Loss
...
- **3.** Select the backup device from the dropdown list of Device Name, as shown in Figure 11. 39.
...
| Destination Address             | 172.6.23.6  |           |   | Test    |
| Network Packet Export           |             |           |   |         |
| Device Name                     | USB1-1      |           | ) | Refresh |
| LAN1                            | 172.6.21.64 | 2,740Kbps |   | Export  |

![](_page_168_Figure_4.jpeg)

- **4.** Click **Export** button to start exporting.
- **5.** After the exporting is complete, click **OK** to finish the packet export, as shown in Figure 11. 40.

| Packet exporting | Attention                      |
|------------------|--------------------------------|
| Cancel           | Packet export succeeded.<br>OK |

Figure 11. 40 Packet Export Attention
...
Figure 11. 43 Network Stat. Interface
...
| Physical Disk | Firmware<br>Array |        |            |                   |        |
|---------------|-------------------|--------|------------|-------------------|--------|
| No.           | Capacity Array    | Type   | Status     | Model             | Hot Sp |
| 22            | 465.76GB          | Normal | Functional | WDC WD5000YS-0  影 |        |
| 26            | 931.51GB          | Normal | Functional | ST31000524NS      | 17     |
...
| Physical Disk<br>Firmware<br>Array |          |                                                                |  |  |                  |  |  |   |                      |
|------------------------------------|----------|----------------------------------------------------------------|--|--|------------------|--|--|---|----------------------|
|                                    | No. Name | Free Space Physic    Hot    Status   Level   Re    Del    Task |  |  |                  |  |  |   |                      |
|                                    | array1 1 | 931/931G 2 6 7                                                 |  |  | Functi  RAID 5 ■ |  |  | m | Initialize (Fast)(Ri |
|                                    |          |                                                                |  |  |                  |  |  |   |                      |
...
| L | Capacity | Status           | Property | Type  | Free Space Gr  Edit D |                      |  |
|---|----------|------------------|----------|-------|-----------------------|----------------------|--|
|   | 931.52GB | Initializing 82% | RW       | Array | OMB                   | Bearing The Research |  |
...
| 26            | 931.51GB       | Normal   | Functional | ST31000524NS      | M      |
| 27            | 931.51GB       | Normal   | Functional | WDC WD10EVVS-6  ■ |        |
|               |                |          |            |                   |        |
|               |                |          |            | One-touch C.      | Create |

Figure 12. 7 Physical Disk Settings Interface

- **2.** Click **Creat** button to enter the Create Array interface.
...
| No. | Capacity Array | Type   | Status     | Model             | Hot Sp |
|-----|----------------|--------|------------|-------------------|--------|
| 1   | 931 51GB       | Normal | Functional | ST3 1000340NS     | 19     |
| 3   | 931,51GB RAID5 | Array  | Functional | ST31000526SV      | I      |
| 5   | 931.51GB RAID5 | Array  | Functional | WDC WD10EVVS-6    | 1      |
...
|---------------------|--------------------------------|--|----------|------------|--|---------------|--|
| No. Name            | Free Space Physic  Hot  Status |  |          | Level      |  | Re  Del  Task |  |
| array1 1            | 931/931G 2 6                   |  | Degraded | RAID 5 B M |  | None          |  |
|                     |                                |  |          |            |  |               |  |
...
| 155 | 931 51GB | Normal | RW       | Local | 848GB                 | 8 |
|-----|----------|--------|----------|-------|-----------------------|---|
|     | Sapacity | Status | Property | Type  | Free Space Gr  Edit D |   |
...
|-----------------|----------------------|----------|-------|-----------------------|---|--|
| Capacity        | Status               | Property | Type  | Free Space Gr  Edit D |   |  |
| 931.51GB        | Initializing 44% RAW |          | Local | OMB                   | I |  |
...
|-----------------|--------|----------|-------|-----------------------|--|--|
| L    Capacity   | Status | Property | Type  | Free Space Gr  Edit D |  |  |
| 5 931 51GB      | Normal | RW       | Local | 848GB                 |  |  |
...
| 931 51GB | Normal | RW       | Local | 848GB                  |  |
|----------|--------|----------|-------|------------------------|--|
| Capacity | Status | Property | Type  | Free Space  Gr  Edit D |  |
...
|                                     |                         | Add NetHDD           |  |  |
|-------------------------------------|-------------------------|----------------------|--|--|
| NetHDD<br>Type<br>NetHDD IP Address |                         | NetHDD 1             |  |  |
|                                     |                         | NAS                  |  |  |
|                                     |                         | .24<br>.201<br>172.6 |  |  |
...
|--------|-------------------------|---------------------------|--|--|--|--|
| Type   |                         | IP SAN                    |  |  |  |  |
|        | NetHDD IP Address       | .210<br>172 .9<br>2       |  |  |  |  |
|        | NetHDD Directory        | ign.2004-05 storos t-8    |  |  |  |  |
| No.    | Directory               |                           |  |  |  |  |
|        | ign 2004-05 storos t-8  |                           |  |  |  |  |
| 2      | ign.2004-05.storos t-41 |                           |  |  |  |  |
| 3      |                         | ign.2004-05.storos.t-1000 |  |  |  |  |
...
|----|----------------|--------|----------------|-------|------------|----|----|---------------|
| 3  | 931.51GB       | Normal | Caroline<br>RW | Local | 890GB      | 1  | 17 | 1             |
| 4  | 931.51GB       | Normal | RM             | Local | 867GB      | 1  | ■  | -             |
| 17 | 79,968MB       | Normal | RIW            | NAS   | 79,872MB   | 11 | 用  | II            |
...
|     | Label Capacity | Status        | Property | Type  | Free Space | Gro  Edit Del |     |   |
|-----|----------------|---------------|----------|-------|------------|---------------|-----|---|
| - 4 | 931.51GB       | Normal        | RW       | Local | 921GB      |               | 17  | 1 |
| 18  | 10,048MB       | Uninitialized | RW       | NAS   | OMB        |               | 房 i |   |
| 25  | 931.51GB       | Normal        | RW       | eSATA | 894GB      |               | 影 丽 |   |

Figure 13. 12 Initialize Added eSATA
...
![](_page_188_Picture_11.jpeg)

Figure 13. 14 Attention for Reboot
...
- **6.** Select HDD from the list and click icon to enter the Local HDD Settings interface, as shown in Figure 13. 15.

![](_page_188_Picture_16.jpeg)

Figure 13. 15 Local HDD Settings Interface
...
Figure 13. 16 Confirm HDD Group Settings
...
- **2.** Select HDD from the list and click the icon to enter the Local HDD Settings interface, as shown in Figure 13. 17.
...
- **2.** Set the **Mode** to Quota, as shown in Figure 13. 18.
...
|--------------------------------|-------------|--|
| Camera                         | IP Camera 1 |  |
| Used Record Capacity           | 8.192MB     |  |
| Used Picture Capacity          | 1,024MB     |  |
| HDD Capacity (GB)              | 931         |  |
| Max. Record Capacity (GB) 80   |             |  |
| Max. Picture Capacity (GB) 100 |             |  |
| A Free Quota Space 751 GB      |             |  |

Figure 13. 18 Storage Mode Settings Interface

- **3.** Select a camera for which you want to configure quota.
- **4.** Enter the storage capacity in the text fields of **Max. Record Capacity (GB)** and **Max. Picture Capacity (GB)**, as shown in Figure 13. 19.
...
| Max Record Capacity (GB)   | 80          |   |              |  |  |  |  |  |
| Max. Picture Capacity (GB) | 100         |   |              |  |  |  |  |  |
| A Free Quota Space 751 G   | 1           | 2 | 3            |  |  |  |  |  |
|                            | 14          | ટ | 6            |  |  |  |  |  |
|                            | 7           | 8 | 9            |  |  |  |  |  |
|                            |             | 0 | A            |  |  |  |  |  |
|                            |             |   | Enter<br>150 |  |  |  |  |  |

Figure 13. 19 Configure Record/Picture Quota

- **5.** You can copy the quota settings of the current camera to other cameras if required. Click the **Copy** button to enter the Copy Camera menu, as shown in Figure 13. 20.

|           |                  | Copy to            |                   |                  |    |                  |
|-----------|------------------|--------------------|-------------------|------------------|----|------------------|
| IP Camera | D1<br>D7<br>DD13 | JD2<br>ID8<br>■D14 | ID3<br>D9<br>DD15 | D4<br>D10<br>DI6 | D5 | DD6<br>■D11 ■D12 |
|           |                  |                    |                   | OK               |    | Cancel           |

Figure 13. 20 Copy Settings to Other Camera(s)
...
|----------------------------|------------|----------|-------|------------|---------|
| Clone Source               |            |          |       |            |         |
| Capacity<br>Label          | Status     | Property | Type  | Free Space | Gr      |
| 931.51GB<br>4              | Normal     | RAN      | Local | 914GB      | 1       |
|                            |            |          |       |            |         |
|                            |            |          |       |            |         |
|                            |            |          |       |            |         |
|                            |            |          |       |            |         |
...
| Clone Destination<br>Usage | Export     |          |       |            | Sel     |

Figure 13. 21 Disk Clone Configuration Interface
...
Figure 13. 22 Setting eSATA Usage
...
Figure 13. 23 Message Box for Disk Clone
...
|---|----------------|-------------|----------|-------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----|
| 4 | 931.51GB       | Cloning 01% | RAV      | Local | Christon Collection Children Children Children Children Children Children Children Children Children Children Children Children Children Children Children Children Children C<br>OMB |    |

Figure 13. 24 Check Disk Clone Progress
...
- **2.** Check the status of each HDD which is displayed on the list, as shown in Figure 13. 25.

| HDD Information |                |               |          |       |            |           |    |      |
|-----------------|----------------|---------------|----------|-------|------------|-----------|----|------|
|                 | Label Capacity | Status        | Property | Type  | Free Space | Gro  Edit |    | Del. |
| 4               | 931.51GB       | Normal        | RMW      | Local | 921GB      | 1         | 17 | -    |
| 18              | 10,048MB       | Uninitialized | RAN      | NAS   | OMB        | 1         | 13 | m    |
| 25              | 931 51GB       | Normal        | RAN      | eSATA | 894GB      | 1         | 1  | =    |
|                 |                |               |          |       |            |           |    |      |
| Total Capacity  |                | 1,872GB       |          |       |            |           |    |      |
| Free Space      |                | 1,815GB       |          |       |            |           |    |      |

Figure 13. 25 View HDD Status (1)
...
- **2.** Click the **HDD** tab to view the status of each HDD displayed on the list, as shown in Figure 13. 26.

|                | Device Info<br>Camera | Record          | Alarm   | Network    | HDD        |        |       |
|----------------|-----------------------|-----------------|---------|------------|------------|--------|-------|
...
Figure 13. 26 View HDD Status (2)
...
- **2.** Select the HDD to view its S.M.A.R.T information list, as shown in Figure 13. 27.
...
|                                              | Raw Read Error Rate      | OK         | 21    | 59        | 200   | 200   | 0         |  |
|                                              | Spin Up Time             | OK         | 27    | 21        | 154   | 107   | 5258      |  |
|                                              | Start/Stop Count         | OK         | 32    | 0         | 100   | 100   | 380       |  |
|                                              | Reallocated Sector Count | OK         | 33    | 140       | 200   | 200   | 0         |  |
|                                              | Seek Error Rate          | OK         | 2e    | 0         | 200   | 200   | 0         |  |
| ID<br>0×1<br>0×3<br>0×4<br>0×5<br>0x7<br>0×9 | Power on Hours Count     | OK         | 32    | 0         | 92    | 92    | 6466      |  |

Figure 13. 27 S.M.A.R.T Settings Interface
...
Figure 13. 28 Bad Sector Detection
...
- **3.** Click the checkbox(s) below to select the HDD error alarm type (s), as shown in Figure 13. 29.
...
Figure 13. 29 Configure HDD Error Alarm
...
| Camera 01<br>Camera Name<br>Display Name<br>><br>05-09-2012 Wed 13:50:45<br>Display Date<br>><br>Display Week<br>><br>MM-DD-YYYY<br>Date Format<br>24-hour<br>Time Format | Camera | IP Camera 3 |              |                            |  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|-------------|--------------|----------------------------|--|
|                                                                                                                                                                           |        |             |              |                            |  |
|                                                                                                                                                                           |        |             |              |                            |  |
|                                                                                                                                                                           |        |             |              |                            |  |
...
|-----|--------------------|-------------------------------------------|----------------------|----------------|---------|---------|--------|
| No. | Major Type         | Time                                      | Minor Type           | Parameter Play |         | Details |        |
| 1   | Operation          | 01-14-2015 21:04:06 Abnormal Shutd  N/A   |                      |                |         | S       |        |
| 2   | T Operation        | 01-14-2015 21:04:08 Power On              |                      | N/A            | -       | 0       |        |
| 3   | Exception          | 01-14-2015 21:04:08 Record Exception N/A  |                      |                | O       | 0       |        |
| 4   | T Operation        | 01-14-2015 21:11:44 Local Operation : N/A |                      |                |         | 0       |        |
| 5   | T Operation        | 01-14-2015 21:39:45 Power On              |                      | N/A            | -       | 6       |        |
| 6   | A Exception        | 01-14-2015 21:39:47                       | Record Exception N/A |                | O       | 0       |        |
| 7   | T Operation        | 01-14-2015 21:44:05 Abnormal Shutd  N/A   |                      |                |         | 0       |        |
| 8   | T Operation        | 01-14-2015 21:44:06 Power On              |                      | N/A            |         | 0       |        |
| 9   | A Exception        | 01-14-2015 21:44:07                       | Record Exception N/A |                | O       | 0       |        |
| 10  | T Operation        | 01-14-2015 21:57:06                       | Abnormal Shutd  N/A  |                |         | 0       |        |
|     | Total: 985 P: 1/10 |                                           |                      |                | DI<br>A |         | V<br>+ |
|     |                    |                                           |                      |                |         |         |        |
|     |                    |                                           |                      | Export         |         | Back    |        |
...
- **6.** If you want to export the log files, click the **Export** button to enter the Export menu, as shown in 上方 Figure 15.5. .
...
|                    |  |                    | Export     |                     |                     |            |  |
|--------------------|--|--------------------|------------|---------------------|---------------------|------------|--|
| Device Name        |  | USB Flash Disk 1-1 |            |                     | 1x1                 | Refresh    |  |
| Name               |  |                    | Size Type  | Edit Date           |                     | Delete Pla |  |
| 111                |  |                    | Folder     |                     | 12-20-2014 12:08:34 | 100        |  |
| @ 128              |  | Folder             |            | 11-04-2014 15:47:38 | m                   |            |  |
| a 256              |  |                    | Folder     |                     | 11-11-2014 16:08:04 | in         |  |
| Channel 003        |  |                    | Folder     |                     | 12-04-2014 15:56:28 | - 241      |  |
| FOUND 000          |  |                    | Foider     |                     | 11-28-2014 11:29:40 | 1          |  |
| Recycled           |  |                    | Folder     |                     | 11-04-2014 15:34:04 | 11         |  |
| recycle. {645FF040 |  |                    | Folder     | 09-16-2013 17:35:24 |                     | nt         |  |
| test               |  |                    | Folder     |                     | 11-21-2014 15:34:22 | m          |  |
| DVD B              |  |                    | Folder     |                     | 07-25-2014 13:37:52 |            |  |
| Free Space         |  | 54.00MB            |            |                     |                     |            |  |
|                    |  |                    | New Folder | Format              | Export              | Cancel     |  |
...
|---------------------------|--------------------|----------------|---------------------|-------------|
| Device Name               | USB Flash Disk 1-1 |                | " bin<br>><br>0     | Refresh     |
| Name                      |                    | Size Type      | Edit Date           | Delete Play |
| = devCla 408198462 20     |                    | 8160.44KB File | 23-01-2015 15:13:50 | 用<br>-      |
|                           |                    |                |                     |             |
| Free Space                |                    | 1895.11MB      |                     |             |
|                           |                    |                |                     |             |
|                           |                    | New Folder     | Export<br>Import    | Back        |
...
| Device Name    | USB Flash Disk 1-1 | ".mp4<br>>          | Refresh |      |
|----------------|--------------------|---------------------|---------|------|
| Name           | Size Type          | Edit Date           | Del     | Play |
| ch01_201412081 | 35.65MB File       | 12-25-2014 18:29:24 | m       | -    |
| ch01_201412100 | 430.15MB File      | 12-25-2014 14:33:18 | ur      | J    |
| ch09_201410291 | 486.88MB File      | 10-29-2014 19:10:56 | m       | I    |
| ch13_201409190 | 2707.10KB File     | 09-19-2014 15:42:20 | m       | 1    |
| d01_sd_ch01_14 | 25.90MB File       | 12-25-2014 17:34:58 | m       | -    |
|                |                    |                     |         |      |
|                |                    |                     |         |      |
...
| Language              | English                                |     |
|-----------------------|----------------------------------------|-----|
| VGA/HDMI Resolution   | 4K(3840*2160)/60HZ                     | >   |
| VGA2/HDMI2 Resolution | 1920*1080/60HZ(1080P)                  | >   |
| Time Zone             | (GMT+08:00) Beijing, Urumqi, Singapore | >   |
| Date Format           | MM-DD-YYYY                             | V   |
| System Date           | 06-23-2015                             | 165 |
| System Time           | 15:08:13                               | 9   |
| Mouse Pointer Speed   | 6<br>1                                 |     |
| Enable Wizard         | >                                      |     |
| Enable Password       | >                                      |     |
...
- **3.** Configure the following settings:
	...
	- **• VGA/HDMI Resolution:** Select the VGA/HDMI output resolution, which must be the same with the resolution of the monitor screen. The following resolutions are supported:
...
**VGA2/HDMI2 Resolution:** Select the VGA/HDMI output resolution: 1920 × 1080p/60Hz, 1600 × 1200/60Hz, 1280 × 1024/60Hz, 1280 × 720/60Hz, 1024 × 768/60Hz.
...
| Auto Logout                | Never<br>V       |
| Enable HDMINGA Simult    Z |                  |
| Menu Output Mode           | Auto<br>14       |
...
- **3.** Configure the following settings:
	...
	- **• Enable HDMI/VGA Simultaneous Output:** By default, the video outputs from HDMI and VGA interfaces can be operated separately. You can set the simultaneous output for the HDMI and VGA by checking the checkbox of the option.
	- **• Menu Output Mode:** You can choose the menu display on different video output. There are auto, HDMI/VGA and Main CVBS selectable.
- **4.** Click the **Apply** button to save the settings.
...
| 1   | admin           | Strong P  Admin |       | 00:00:00:00:00:00  |     | = | if   | -            |
|     |                 |                 |       |                    |     |   |      |              |
|     |                 |                 |       |                    |     |   |      |              |
|     |                 |                 |       |                    |     |   |      |              |
|     |                 |                 |       |                    |     |   |      |              |
...
**<sup>3.</sup>** Enter the information for new user, including **User Name**, **Password**, **Confirm**, **Level** and **User's MAC** 
...
| 1 | admin |          |                   |              |
|---|-------|----------|-------------------|--------------|
|   |       | Admin    | 00:00:00:00:00:00 | I<br>1       |
| 2 | 01    | Operator | 00:00:00:00:00:00 | 0<br>S<br>12 |
|   |       |          |                   |              |

Figure 16. 9 User List

- **3.** Click the icon to delete the selected user account.
### **16.5.3Editing a User**
...
| Change Password                    | D                                                                                                                                          |        | Old Password                       |                                                                                                                                              |
| Password                           |                                                                                                                                            | Strong | Change Password                    | D                                                                                                                                            |
| Confirm                            | SERSESSERS!                                                                                                                                |        | Password                           | Strong                                                                                                                                       |
| Level                              | Operator                                                                                                                                   | >      | Confirm                            |                                                                                                                                              |
| User's MAC Address                 | 00: 00: 00: 00: 000:00                                                                                                                     |        | User's MAC Address                 | 00 :00 :00 :00 :00 :00                                                                                                                       |
| least two kinds of them contained. | Valid password range [8-16]. You can use a combination of numbers,<br>lowercase, uppercase and special character for your password with at |        | least two kinds of them contained. | @ Valid password range [8-16]. You can use a combination of numbers,<br>lowercase, uppercase and special character for your password with at |
|                                    | OK                                                                                                                                         | Cancel |                                    | OK<br>Cancel                                                                                                                                 |
...
- **6.** For the **Operator** or **Guest** user account, you can also click the button on te user management interface to edit the permission.
...
| Video/Audio<br>input | IP video input                     | Up to 12 Mp resolution                 |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Two-way audio                      | 1-ch, RCA (2.0 Vp-p, 1kΩ)              |                                                                                                                                                                                           |                                                  |                                                        |
| Network              | Incoming bandwidth                 | 128Mbps                                | 256Mbps,<br>or 200Mbps (when<br>RAID is enabled)                                                                                                                                          | 320Mbps,<br>or 200Mbps (when<br>RAID is enabled) | 320Mbps,<br>or<br>200Mbps<br>(when<br>RAID is enabled) |
...
| Video/Audio          | VGA1 /HDMI1 output<br>resolution   |                                        | 4K (3840 ×2160)/60Hz (supported by HDMI1 only),<br>4K (3840 ×2160)/30Hz, 2K (2560 ×1440)/60Hz, 1920 × 1080p/60Hz, 1600 × 1200/60Hz,<br>1280 × 1024/60Hz, 1280 × 720/60Hz, 1024 × 768/60Hz |                                                  |                                                        |
| output               | VGA2 /HDMI2 output<br>resolution   |                                        | 1920 × 1080p/60Hz, 1280 × 1024/60Hz, 1280 × 720/60Hz, 1024 × 768/60Hz                                                                                                                     |                                                  |                                                        |
|                      | Audio output                       | 2-ch, RCA (2.0Vp-p, 1 KΩ)              |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Decoding format                    | H.265/H.264/MPEG4                      |                                                                                                                                                                                           |                                                  |                                                        |
| Decoding             | Live view / Playback<br>resolution |                                        | 12Mp/8Mp/6Mp/5Mp/4Mp/3Mp/1080p/UXGA/720p/VGA/4CIF/DCIF/2CIF/CIF/QCIF                                                                                                                      |                                                  |                                                        |
...
| Disk array           | Number of arrays                   | 4                                      |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Network interface                  |                                        | 2, RJ-45 10/100/1000 Mbps self-adaptive Ethernet interface                                                                                                                                |                                                  |                                                        |
| External             | Serial interface                   | RS-232; RS-485; Keyboard               |                                                                                                                                                                                           |                                                  |                                                        |
| interface            | USB interface                      |                                        | Front panel: 2 × USB 2.0; Rear panel: 1 × USB 3.0                                                                                                                                         |                                                  |                                                        |
|                      | Alarm in/out                       | 16/4                                   |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Power supply                       | 100 to 240 VAC, 50 to 60 Hz            |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Max. Power                         | 200 W                                  |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Consumption<br>(without hard disk) | ≤30 W                                  |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Working temperature                | -10 to +55ºC (14 to 131ºF)             |                                                                                                                                                                                           |                                                  |                                                        |
| General              | Working humidity                   | 10 to 90 %                             |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Chassis                            | 19-inch rack-mounted 2U chassis        |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Dimensions(W × D × H)              | 445 × 470 ×90 mm (17.5"× 18.5" × 3.5") |                                                                                                                                                                                           |                                                  |                                                        |
|                      | Weight(without hard<br>disk)       | ≤ 10 Kg (22 lb)                        |                                                                                                                                                                                           |                                                  |                                                        |
...
| File<br>Ontiol       | View Help             |                               |            |             |
|----------------------|-----------------------|-------------------------------|------------|-------------|
| Applications         | Processes<br>Services | Performance                   | Networking | I sers      |
...
| Kernel Memory (MB)   |                       | Commit (MB)                   |            | 1463 / 6119 |
| Paged                | 185                   |                               |            |             |
...
| Type    |                            | Model<br>Version    | Max.       | Sub-stream | Audio |
|---------|----------------------------|---------------------|------------|------------|-------|
|         |                            |                     | Resolution |            |       |
...
| HD<br>Network<br>Camera | DS-2CD9122        | V3.7.1 build140417  | 1920*1080          | √          | ×     |
...
| Network | DS-2DF7274-AH/DH/AFH               | V5.2.8 build150124 | 1280*960           | √          | √     |
| Speed   | iDS-2DF7274-AH/DH/AFH              | V5.2.8 build150124 | 1280*960           | √          | √     |
| Dome    | DS-2DF5274-AH/DH/A3H/D3H/AFH/A3FH  | V5.2.8 build150124 | 1280*960           | √          | √     |
...
User Manual of Network Video Recorder User Manual